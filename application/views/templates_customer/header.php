...
<head>
    ...
    <title>CV.Rizky Auto Rental</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <a href="<?php echo base_url('Customer/Dashboard')?>" class="">
                            <h3 class="ml-3" style = "color: #FFD700">CV. Rizky Auto Rental</h3>
                            <h3 class="ml-3 btn-sm" style = "color: white">Padang, Sumatera Barat</h3>
                        </a>
                    </div>
                    <!--== Logo End ==-->
                        ...
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <?php if($this->session->userdata('nama')) { ?>
                                  ...
                                  <li><a href="<?php echo base_url('Customer/About')?>">Tentang</a></li>
                                  <li><a href="<?php echo base_url('Customer/Ketentuan')?>">Ketentuan</a></li>
                                  <li><a class="mr-5"  href="<?php echo base_url('Auth/logout')?>">Welcome <?php echo $this->session->userdata('nama')?> <span> | Logout</span></a></li>
                                <?php } else { ?>
                                  <li><a href="<?php echo base_url('Customer/About')?>">Tentang</a></li>
                                  <li><a href="<?php echo base_url('Register')?>">Daftar</a></li>
                                  <li><a class="mr-5" href="<?php echo base_url('Auth/login')?>">Masuk</a></li>
                                <?php } ?>
                            </ul>
                        </nav>
                    </div>
